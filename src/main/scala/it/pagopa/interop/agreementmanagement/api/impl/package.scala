...
package object impl extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val agreementDocumentSeedFormat: RootJsonFormat[AgreementDocumentSeed] = jsonFormat2(AgreementDocumentSeed)
  implicit val agreementDocumentFormat: RootJsonFormat[AgreementDocument]         = jsonFormat4(AgreementDocument)
