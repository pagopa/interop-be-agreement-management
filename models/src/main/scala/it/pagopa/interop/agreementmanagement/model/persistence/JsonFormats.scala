...
object JsonFormats {
  ...
  implicit val pssFormat: RootJsonFormat[PersistentStamps]             = jsonFormat6(PersistentStamps.apply)
  implicit val paFormat: RootJsonFormat[PersistentAgreement]           = jsonFormat18(PersistentAgreement.apply)
