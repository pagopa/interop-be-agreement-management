...
object AgreementApi {
  ...
  def apply(baseUrl: String = "https://gateway.interop.pdnd.dev/pdnd-interop-uservice-agreement-management/}") =
    new AgreementApi(baseUrl)
}
...
class AgreementApi(baseUrl: String) {
  ...
  /** activates the agreement, if any.
    ...
    *
    * @param agreementId
    * @param stateChangeDetails
    */
  def activateAgreement(agreementId: String, stateChangeDetails: StateChangeDetails)(implicit
    bearerToken: BearerToken
  ): ApiRequest[Agreement] =
  ...
  )(implicit bearerToken: BearerToken): ApiRequest[Seq[Agreement]] =
  ...
  /** suspends the agreement by id
    ...
    *
    * @param agreementId
    * @param stateChangeDetails the updated attribute
    */
  def suspendAgreement(agreementId: String, stateChangeDetails: StateChangeDetails)(implicit
    bearerToken: BearerToken
  ): ApiRequest[Agreement] =
  ...
  /** patches the verified attribute of the agreement as specified in the operation payload.
    ...
    */
  def updateAgreementVerifiedAttribute(agreementId: String, verifiedAttributeSeed: VerifiedAttributeSeed)(implicit
    bearerToken: BearerToken
  ): ApiRequest[Agreement] =
    ApiRequest[Agreement](ApiMethods.PATCH, baseUrl, "/agreements/{agreement_id}/attribute", "application/json")
      .withCredentials(bearerToken)
      .withBody(verifiedAttributeSeed)
      .withPathParam("agreement_id", agreementId)
      .withSuccessResponse[Agreement](200)
      .withErrorResponse[Problem](400)
      .withErrorResponse[Problem](404)
  ...
  /** upgrades an agreement with a newer eservice version, if any.
    ...
    */
  def upgradeAgreementById(agreementId: UUID, agreementSeed: AgreementSeed)(implicit
    bearerToken: BearerToken
  ): ApiRequest[Agreement] =
