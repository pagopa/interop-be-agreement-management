...
package object impl extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val documentSeedFormat: RootJsonFormat[DocumentSeed]                 = jsonFormat3(DocumentSeed)
  implicit val verifiedAttributeFormat: RootJsonFormat[VerifiedAttribute]       = jsonFormat2(VerifiedAttribute)
  ...
  implicit val agreementFormat: RootJsonFormat[Agreement]                       = jsonFormat14(Agreement)
